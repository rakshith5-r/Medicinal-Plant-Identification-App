    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          AnimatedAlign(
            alignment:
                _showPopupButtons ? Alignment(0.4, 0.9) : Alignment(0.0, 1.15),
            duration: Duration(milliseconds: 300),
              ...
              children: [
                Container(
                  ...
                  child: IconButton(
                    onPressed: () async {
                      await controller
                          .captureImage(); // TODO: implement action for camera icon
                      FileImage f =
                      ...
                      if (controller.imagePath.toString() != "") {
                        Navigator.push(context, MaterialPageRoute(
                          builder: (context) {
                            return ScannerAnim(
                              f: f,
                              pred: File(controller.imagePath.toString()),
                            );
                          },
                        ));
                      } else {
              ...
              children: [
                Container(
                  ...
                  child: IconButton(
                    onPressed: () async {
                      await controller
                          .getImage(); // TODO: implement action for photo icon
                      FileImage f =
                          FileImage(File(controller.imagePath.toString()));
                      if (controller.imagePath.toString() != "") {
